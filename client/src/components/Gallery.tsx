  ...
  return (
    <section id="gallery" className="section-padding bg-white">
      <div className="container mx-auto px-4">
        <SectionHeading
          title="Our Projects"
          description="Take a look at some of our recent construction and interior projects"
        />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project) => (
            <div 
              key={project.id} 
              className="overflow-hidden rounded-lg shadow-lg cursor-pointer group transition-all duration-300 hover:shadow-xl"
            >
              <img
                src={project.image}
                alt={project.title}
        ...
        <div className="mt-10 text-center">
          <ScrollLink to="contact">
            <Button 
              className="bg-red-500 hover:bg-red-600 text-white px-6 py-3 rounded inline-flex items-center justify-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="mr-2 h-5 w-5"
              ...
              <span className="inline-block">Inquire About Your Project</span>
            </Button>
          </ScrollLink>
        </div>
      </div>
