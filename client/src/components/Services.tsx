        ...
        >
          {services.map((service, index) => (
            ...
            >
              ...
              {/* Icon - FIXED to be visible in mobile using absolute positioning */}
              <motion.div 
                className="absolute w-14 h-14 bg-accent rounded-full flex items-center justify-center left-6 -mt-7 border-4 border-white shadow-md"
                initial={{ scale: 0 }}
                whileInView={{ scale: 1 }}
                viewport={{ once: true }}
                transition={{ 
              ...
              <div className="p-6">
                <h3 className="text-xl font-heading font-semibold mb-3 mt-4">
                  {service.title}
                </h3>
                <p className="text-gray-600 mb-4">{service.description}</p>
                <ScrollLink
